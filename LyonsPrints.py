...
class Window:
    ...
    def LoginMenu(self):
        ...
        tk.Entry(self.titleFrame, textvariable=password, show='•', width=30).pack()
    ...
    def getInfo(self, function, text, title, option):
        ...
        tk.Button(self.infoFrame, text="Search",
                  command=lambda: self.findTicket(function, text, title, option)).pack()
        ...
        if option == 0:
            ...
            tk.Entry(self.infoFrame, textvariable=self.dateToday).pack()
            tk.Label(self.infoFrame, text="Staff Initials:").pack()
            tk.Entry(self.infoFrame, textvariable=self.StaffInitials).pack()
            ...
            tk.Entry(self.infoFrame, textvariable=self.CourseCode).pack()
            tk.Label(self.infoFrame, text="Affiliation:").pack()
            tk.Entry(self.infoFrame, textvariable=self.affiliation).pack()
            tk.Label(self.infoFrame, text="Department:").pack()
            tk.Entry(self.infoFrame, textvariable=self.department).pack()
            ...
            tk.Entry(self.infoFrame, textvariable=self.handle).pack()
            tk.Label(self.infoFrame, text="File Name:").pack()
            tk.Entry(self.infoFrame, textvariable=self.Fname).pack()
            tk.Label(self.infoFrame, text="SD card:").pack()
            tk.Entry(self.infoFrame, textvariable=self.SD).pack()
            tk.Label(self.infoFrame, text="Print Time:").pack()
            tk.Entry(self.infoFrame, textvariable=self.Ptime).pack()

        elif option == 2:
            tk.Label(self.infoFrame, text="Enter Reason:").pack()
            tk.Entry(self.infoFrame, textvariable=self.reasonEntry, width=40).pack()
        elif option == 3:
            tk.Label(self.infoFrame, text="Date of original message:").pack()
            tk.Entry(self.infoFrame, textvariable=self.dateEntry1, width=9).pack()
            tk.Label(self.infoFrame, text="Last date to pickup print:").pack()
            tk.Entry(self.infoFrame, textvariable=self.dateEntry2, width=9).pack()
        elif option == 4:
            tk.Label(self.infoFrame, text="Cancel Request if Patron doesn't respond by:").pack()
            tk.Entry(self.infoFrame, textvariable=self.responseDate, width=15).pack()
